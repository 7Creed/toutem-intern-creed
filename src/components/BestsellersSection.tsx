...
export default function BestsellersSection() {
  return (
    <section className="bg-white px-5 md:px-20 lg:px-25 py-16 flex items-center">
      <div className="relative mb-10 w-1/2 bg-[]">
        <h3 className="text-green-500 text-2xl font-semibold mb-2">
          Bestsellers
        </h3>
